...
二、过程：
	**I.a) 系统识别起点**
	- 开始：识别工作应从系统的核心功能或参考流出发，即前景系统的中心过程或待分析系统本身。
	**I.b) 前景系统的扩展**
	- 进展：逐步将识别范围扩展至整个前景系统。
	- 方法：遵循“供应链 - 使用 - 生命周期终结”的逻辑，识别所有相关的产品和废物流，包括那些跨越背景系统边界的。
	**I.c) 背景系统的识别**
	- 对等处理：背景系统内的过程也应按照前景系统相同的逻辑进行识别。
	- 指导：详细的识别程序在本章节的主文中有所说明。
	**I.d) 排除的证明与记录**
	...
	**I.e) 部分系统与系统间关系**
	- 注意点：对于部分系统和系统间关系（如能源产品）需要特别注意并进行正确的识别。
	**I.f) 技术流程图与产品和废物列表**
	- 工具：建议使用系统边界方案进行概览。
	- 应用：技术流程图和连接前景与背景系统的产品和废物列表有助于记录关键数据，并作为数据收集和文档编制的基础。
	**II) 初步过程描述的必要性**
	- 要求：提供前景系统单元过程的初步描述，并详细说明连接背景系统的产品和废物流的功能单位。
	- 更新：在生命周期评估（LCI）的迭代步骤中更新这些描述，以反映前景系统的最终单元过程。
	**注意事项：**
	- 背景系统中的个别过程在必要时也需要识别，尤其是当涉及敏感问题或在满足特定研究目标时。
	- 需要遵守关于技术、地理和时间相关性的规定要求。
	- 初步生成的列表可能需要根据初步生命周期模型、影响评估和解释结果进行细化。
